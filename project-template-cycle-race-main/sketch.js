...
var pathImg, mainRacerImg1, mainRacerImg2, mainRacerCollidedImg;
...
function preload() {
  ...
  mainRacerCollidedImg = loadAnimation("mainPlayer3.png"); 
...
function setup() {
  ...
  mainCyclist.addAnimation("SahilCollided", mainRacerCollidedImg); 
...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    if (pinkCG.isTouching(mainCyclist)) {
      ...
      mainCyclist.changeAnimation("SahilCollided"); 
    }
